...
export function CreateVaultScreen({
  navigation,
}: NativeStackScreenProps<RootStackParamList, "CreateVault">) {
  ...
  const createVaultButtonTranslateX = useSharedValue(0);
  const createVaultButtonTranslateXAnimatedStyle = useAnimatedStyle(() => {
    return {
      transform: [
        {
          translateX: createVaultButtonTranslateX.value,
        },
      ],
    };
  });

  const shakeCreateVaultButton = () => {
    const offset = 2;
    const duration = 50;
    createVaultButtonTranslateX.value = withSequence(
      withTiming(offset, {
        duration: duration,
        easing: EASING,
      }),
  ...
  const handleCreateVaultPress = async () => {
    if (formPassword) {
      await createVault(formPassword);
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {lang.createVaultScreen.passwordCautionFirstLine}
                {"\n"}
                {lang.createVaultScreen.passwordCautionSecondLine}
              </Text>
            </View>
            <View
              style={{
            ...
            >
              ...
              <ScalablePressable
                style={[
                  ...
                  createVaultButtonTranslateXAnimatedStyle,
                ]}
