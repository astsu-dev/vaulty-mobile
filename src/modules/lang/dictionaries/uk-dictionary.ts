...
export const ukDictionary: LangDictionary = {
  ...
  remoteClipboardSettingsScreen: {
    ...
    description:
      'Віддалений буфер обміну дозволяє копіювати паролі на інший пристрій. Важливо використовувати сильний пароль, оскільки він використовується для шифрування даних під час їх передачі між пристроями. Для того, щоб переглянути як налаштувати віддалений буфер обміну натисніть кнопку "Як налаштувати?" нижче.',
    setupGuideLink:
